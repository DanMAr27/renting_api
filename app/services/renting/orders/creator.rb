    ...
    class Creator
      ...
      def create_assignment
        ...
        Renting::OrderAssignment.create!(
          order: @order,
          usage_type: assignment_params[:usage_type],
          driver_id: assignment_params[:driver_id].to_i.zero? ? nil : assignment_params[:driver_id],
          cost_center_id: assignment_params[:cost_center_id].to_i.zero? ? nil : assignment_params[:cost_center_id],
          department_id: assignment_params[:department_id].to_i.zero? ? nil : assignment_params[:department_id],
          division_id: assignment_params[:division_id].to_i.zero? ? nil : assignment_params[:division_id]
        )
      end
      ...
      def create_services
        ...
        @params[:service_ids].reject { |id| id.to_i.zero? }.each do |service_id|
